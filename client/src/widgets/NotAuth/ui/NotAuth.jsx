    ...
    return (
        <div className={classNames(cls.NotAuth, {}, [className])}>
            <section className="p-6 dark:bg-gray-800 dark:text-gray-100">
                <div className={classNames(cls.container, {}, ["container grid gap mx-auto text-center lg:grid-cols-2 xl:grid-cols-5"])}>
                    <div className="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-gray-900">
                        <span className="block mb-2 dark:text-violet-400">SUPER PRO MAX</span>
                        <h1 className="text-5xl font-extrabold dark:text-gray-50">ВиК Мениджър</h1>
                        ...
                        <div className={classNames(cls.NotAuth, {}, ["flex flex-wrap justify-center"])}>
                    ...
                    <img src={NotFound} alt="" className="object-cover ml-auto sm:m-auto max-w-sm rounded-md xl:col-span-3 dark:bg-gray-500" />
                </div>
            </section>
        </div>
    );
