        ...
        <section className="p-6 dark:bg-gray-800 dark:text-gray-100">
          <div
            className={classNames(cls.container, {}, [
              "container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl",
            ])}
          >
            <div className="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-gray-900">
              ...
              <p className="my-8 underline">
                За да ползвате нашите услуги трябва да влезете във вашият
                профил.
              </p>
              <p className="my-8">
